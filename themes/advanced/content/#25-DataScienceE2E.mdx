...
The data science workflow can be cumbersome for beginners to handle and often some parts are forgotten completely, such as splitting the data set into test, validation and training data. In this blog post I cover each step of a typical data science workflow and explain what we will achieve during the step, some of my watch-its and the packages or tools that can help you along the way - no what size your data is.
