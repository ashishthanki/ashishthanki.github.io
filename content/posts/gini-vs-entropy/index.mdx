---
title: Impurity Criterions 
date: 2020-02-26
slug: "/gini-vs-entropy"
tags:
  - Mathematics
  - Machine Learning
---
...
<center><img src="https://miro.medium.com/max/1400/1*ool361dWI61RMDyUAmalmA.png" style="width:60%; height:10%"/></center>
...
<center><img src="https://3qeqpr26caki16dnhd19sv6by6v-wpengine.netdna-ssl.com/wp-content/uploads/2016/02/Example-Decision-Tree.png" style="width:70%; height:10%"/></center>
...
```markup
I_G (D_p, f) = I(D_p) - \displaystyle \sum_{j=1}^{m} \frac{N_j}{N} I(D_j)  =  I(D_p) - \frac{N_{left}}{N} I(D_{left}) - \frac{N_{right}}{N} I(D_{right})
```
.
...
![Thermodynamics 2nd Law](https://digitalhealth336302788.files.wordpress.com/2020/04/biro-2nd-law.jpg)
...
> … information gain, is simply the expected reduction in entropy caused by partitioning the examples according to this attribute. by https://www.amazon.com/Learning-McGraw-Hill-International-Editions-Computer/dp/0071154671/ref=as_li_ss_tl?keywords=machine+learning&qid=1563151324&s=books&sr=1-44&linkCode=sl1&tag=inspiredalgor-20&linkId=5488f209b18fb6b8ad8ce7f72d1c3ac5&language=en_US 
