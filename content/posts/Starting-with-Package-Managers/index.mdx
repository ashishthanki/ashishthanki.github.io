...
date: 2021-01-31
description: The importance of an easy to use package manager is often over looked. Being able to manage and create virtual environments is a key skill for Data Scientists.
tags:
  - Package Manager
  - PIP
  - Anaconda
  - Dependency
banner: ./Mini-CondavsAncaconda.png
---
...
<center><img src="https://thumbs.gfycat.com/ImmediateWastefulCockroach-small.gif" style="width:60%;"/></center>
...
![Conda Illustration](./conda_illustration.png)
...
![MinivsAnaconda](./Mini-CondavsAncaconda.png)
...
Just like with `git` and how you should avoid developing on the `master` branch, you should avoid developing projects based on the defaul `base` environment. A new environment should be created, and development work should be done on that. Further command line arguments can be found in the Conda website [guide](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html#creating-an-environment-with-commands).
